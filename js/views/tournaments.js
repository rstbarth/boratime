...
https://boratime.app/#tournaments/${t.id}</textarea>
                      ...
                      <div class="invite-tab-content" id="tab-whats-${t.id}" style="display: none; text-align: center;">
                         ...
                         <button class="btn hover-lift" style="width: 100%; background: #25D366; color: white; border: none; font-weight: 600; padding: 10px;" onclick="window.open('https://api.whatsapp.com/send?text=Participe do torneio: ${encodeURIComponent(t.name)}%0Ahttps://boratime.app/#tournaments/${t.id}', '_blank')">💬 Enviar Mensagem</button>
                      </div>
                      <div class="invite-tab-content" id="tab-qr-${t.id}" style="display: none; text-align: center;">
                         ...
                         <div style="background: white; padding: 10px; border-radius: 12px; display: inline-block;">
                            <img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&color=111111&data=https://boratime.app/#tournaments/${t.id}" alt="QR Code" width="150" height="150" style="display: block;">
                         </div>
                      </div>
                   </div>
                </div>
