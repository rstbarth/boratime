  ...
  const html = `
    <div class="modal-overlay" id="modal-about">
      <div class="modal" style="max-width:420px; text-align:center; padding:2rem;">
        ...
        <h2 style="margin:0 0 0.25rem; font-size:1.5rem; font-weight:800; color:var(--text-bright);">Boratime</h2>
        <p style="margin:0 0 1rem; font-size:0.85rem; color:var(--text-muted);">Versão ${window.BORATIME_VERSION || '0.1.0-alpha'}</p>
        ...
        <p style="font-size:0.75rem; color:var(--text-muted); margin:0 0 1.5rem;">© 2026 Boratime. Todos os direitos reservados.</p>
...
console.log("Boratime App Inicializado com Sucesso");
